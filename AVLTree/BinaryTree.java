...
public class BinaryTree<T extends Comparable<T>> {
    ...
    public void deleteByCopying(T data) {
        // * tree is empty or it has single node.
        if (root == null)
        ...
        queue.add(root);
        BTNode<T> keyNode = null; // * The node to be deleted, first occurance.
        ...
        while (!queue.isEmpty()) {
            ...
            // * The deleted node is replaced by the last node,
            // * parentNode = last node parent
